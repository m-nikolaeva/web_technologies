...
[
    ...
    'description' => 'Работа тестировщика - тестировать что дали :). Работа тестировщика - такая вот работа. Работа тестировщика - такая вот работа.'
],
[
    'job' => 'Аналитик', 
    'dateStart' => 'Март 2012',
    'dateEnd' => 'Декабрь 2014', 
    'description' => 'Работа аналитика - анализируй это. Работа аналитика - анализируй то. Работа аналитика - анализируй все.'
],
[
    'job' => 'Дизайнер', 
    'dateStart' => 'Июнь 2010', 
    'dateEnd' => 'Март 2012',
    'description' => 'Такой вот дизайнерский дизайнер. Такой вот дизайнерский дизайнер. Такой вот дизайнерский дизайнер.'
],
];
?>
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <?php for($i = 0; $i < count($experience); $i++): ?>
         <div class="w3-container">
          <h5 class="w3-opacity"><b><p><?php echo $experience[$i]['job']; ?></p></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $experience[$i]['dateStart']; ?> - 
            ...
            <?php if ($i == count($experience) - 1): ?>
                <p><?php echo $experience[$i]['description']; ?></p><br>
            <?php else: ?>
